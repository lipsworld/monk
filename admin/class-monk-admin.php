...
class Monk_Admin {
	...
	/**
	 * Function to save monk tools fields
	 *
	 * @since    0.4.0
	 *
	 * @return void
	 */
	public function monk_save_tools() {
		if ( check_ajax_referer( '_monk_tools', '_monk_tools', false ) ) {
			if ( filter_input( INPUT_POST, 'monk_set_language_to_elements' ) ) {
				$this->monk_set_language_to_elements();
			}
			$this->monk_use_google_translate();
	...
	/**
	 * Function to save google translate options
	 *
	 * @since    0.4.0
	 *
	 * @return mixed $response
	 */
	public function monk_use_google_translate() {
		$monk_translate = filter_input( INPUT_POST, 'monk_translate' );
		update_option( 'monk_translate', ! empty( $monk_translate ) );
		if ( ! empty( $monk_translate ) ) {

			$monk_translate_fields = '{"type": "' . filter_input( INPUT_POST, 'monk_translate_type' ) . '","project_id": "' . filter_input( INPUT_POST, 'monk_translate_project_id' ) . '","private_key_id": "' . filter_input( INPUT_POST, 'monk_translate_private_key_id' ) . '","private_key": "' . filter_input( INPUT_POST, 'monk_translate_private_key' ) . '","client_email": "' . filter_input( INPUT_POST, 'monk_translate_client_email' ) . '","client_id": "' . filter_input( INPUT_POST, 'monk_translate_client_id' ) . '","auth_uri": "' . filter_input( INPUT_POST, 'monk_translate_auth_uri' ) . '","token_uri": "' . filter_input( INPUT_POST, 'monk_translate_token_uri' ) . '","auth_provider_x509_cert_url": "' . filter_input( INPUT_POST, 'monk_translate_auth_provider_x509_cert_url' ) . '","client_x509_cert_url": "' . filter_input( INPUT_POST, 'monk_translate_client_x509_cert_url' ) . '"}';
			update_option( 'monk_translate_fields', $monk_translate_fields );
			file_put_contents( plugin_dir_path( dirname( __FILE__ ) ) . 'google-translate.json', $monk_translate_fields );
		}
	}
	...
	public function monk_save_site_options() {
		if ( check_ajax_referer( '_monk_site_options', '_monk_site_options', false ) ) {
			$default_language = get_option( 'monk_default_language', false );
			$active_languages = get_option( 'monk_active_languages', array() );
